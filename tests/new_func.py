...
drive_xarray_dataset = to_xarray_dataset(sim_data[1])

drive_xarray_dataset['mz'].isel(t=0, z=0).plot.imshow('x', 'y')
...
drive_fft_dataset = xarray_dataset_rfft(drive_xarray_dataset)
drive_fft_dataset
